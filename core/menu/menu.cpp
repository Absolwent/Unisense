...
void menu::render() {
	...
	do_frame(variables::ui::menu::x, variables::ui::menu::y, variables::ui::menu::w, variables::ui::menu::h,
		color(36, 36, 36, 255), color(25, 25, 25, 255), color(36, 36, 36, 255), "Unisense ver. 0.0.1 beta");
	...
	switch (current_tab) {
		...
		case 3: {	// Config
			...
			gui::add_groupbox("Skins", 2); {
				gui::add_button("Load skins from config",					skins::read_skins);
				gui::add_button("Enable skins (VAC Risk!)",	button_functions::full_update);
			}
